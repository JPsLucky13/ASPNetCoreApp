...
namespace CourseProjectApp.Services
{
    public class MessageSend : IEmailSend , ISmsSend
    {
        ...
        public Task SendEmailAsync(string email, string subject, string message)
        {
            ...
            myMessage.From = new MailAddress("jeanpaulpeschard43@gmail.com", "Jean-Paul");
        ...
        public async Task SendSmsAsync(string number, string message)
        {
            ...
            {
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Basic", Convert.ToBase64String((Encoding.ASCII.GetBytes($"{Options.Sid}:{Options.AuthoToken}"))));
